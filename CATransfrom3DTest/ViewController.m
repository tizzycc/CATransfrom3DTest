...
@property (nonatomic, strong) UIView *matrixBoxView;
@property (nonatomic, strong) UISlider *sliderView, *xRotationSliderView, *yRotationSliderView, *zRotationSliderView;
@property (nonatomic, strong) UILabel *xRotationLabel, *yRotationLabel, *zRotationLabel;
...
- (void)viewDidLoad
{
    ...
    UISlider *xAnchorSliderView = [[UISlider alloc] initWithFrame:CGRectMake(self.gridView.frame.origin.x, self.gridView.frame.origin.y+self.gridView.frame.size.height+100, self.gridView.frame.size.width, 40)];
    ...
    UISlider *yAnchorSliderView = [[UISlider alloc] initWithFrame:CGRectMake(-100, self.gridView.frame.origin.y+(self.gridView.frame.size.height)/2-20, self.gridView.frame.size.width, 40)];
...
-(GridView *)gridView{
    if (!_gridView) {
        ...
        _gridView = [[GridView alloc]initWithFrame:CGRectMake(([self.view bounds].size.width-300)/2, 50, 301, 301)];
    }
    return _gridView;
